...
#             left = 2 * i
#             right = 2 * i + 1
#             self.H[i], self.H[self.size()] = self.H[self.size()], self.H[i]
#             self.H.remove(self.H[self.size()])
#             self.bubble_down(i)
#
#
# class TopKHeap:
...
#         # your code here
#         self.H.insert(elt)
#         #last element of A should be less than first element of heap H
#         # print(self.A[self.k-1])
#         # print(self.H.H[1])
#
#         if self.A[self.k-1] > self.H.H[1]: #-2 insertin
#             self.insert_into_A(self.H.H[1]) #[-10, -9, -8, -4, -2, 0]
#             insertH = self.A[len(self.A) - 1] #0
#             print(f'inserHis {insertH}')
#             self.A.remove(self.A[len(self.A)-1])
#             print(self.A[len(self.A) - 1])
#             self.H.delete_min()
#             self.H.insert(insertH) #[1, 4, 5, 6, 15, 22, 31, 7]
#
#             # print(self.A[self.k - 1])
#
#
...
class MaxHeap:
    ...
    # Use bubble_up/bubble_down function
    def insert(self, elt):  #[5,2,4,-1,7]
        self.H.append(elt)
        self.bubble_down(self.size())
